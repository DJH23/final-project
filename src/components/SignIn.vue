  ...
  <div class="flex justify-center my-2 mx-4 md:mx-0">
    ...
    >
      <div class="flex flex-wrap -mx-3 mb-6">
        ...
        <div class="w-full md:w-full px-3 mb-6">
          <button
            class="appearance-none block w-full bg-yellow-500 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-purple-500 focus:outline-none focus:bg-white focus:border-gray-500 transition duration-250 ease-in-out"
            type="submit"
          >
            Sign in
          </button>
...
// my images
const hawtin =
  "https://res.cloudinary.com/dty6nmroj/image/upload/v1664873711/task-app-vue/hawtin.jpg";
